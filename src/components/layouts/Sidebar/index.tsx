            ...
            <li>
              ...
              {isDropdownOpen && (
                <ul className="pl-4 bg-blue-900">
                  <li className="px-4 py-2 hover:bg-blue-950">Account</li>
                  <li className="px-4 py-2 hover:bg-blue-950">Orders</li>
                </ul>
              )}
            </li>
            <li className="px-4 py-2 hover:bg-blue-950">Product</li>
